...
class frs_generator:
    ...
    def publish_frs(self):
        ...
        for i in range(self.n_bots):
            ...
            with open('/home/izzie/catkin_ws/src/navlab_turtlebot/navlab_turtlebot_frs/data/happyfrsfirst.csv', 'w', newline='') as csvfile:
            ...
            for t, zono in enumerate(second.pzonotopes):
                rows.append([[self.t_sim+t*.1] + list(zono.generators.flatten())])
            with open('/home/izzie/catkin_ws/src/navlab_turtlebot/navlab_turtlebot_frs/data/happyfrssecond.csv', 'w', newline='') as csvfile:
                csvwriter = csv.writer(csvfile)
                csvwriter.writerows(rows)
            ...
            with open('/home/izzie/catkin_ws/src/navlab_turtlebot/navlab_turtlebot_frs/data/happyfrsthird.csv', 'w', newline='') as csvfile:
                csvwriter = csv.writer(csvfile)
                csvwriter.writerows(rows)
